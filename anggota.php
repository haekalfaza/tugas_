<link rel="stylesheet" href="bootstrap-5.1.3-dist/css/bootstrap.">
...
if(isset($_GET['update'])){
    ...
    if ($query_update) {
        ...
        <?php
        header('refresh:0  URL=http://localhost/14_mywebsite_12RPL2/admin.php?page=anggota');
    }
}
?>
...
<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#inputmodal">
  Tambah Data
</button>
<br>
